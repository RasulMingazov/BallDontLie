...
internal class DefaultTeamLocalDataSource(
    ...
    override suspend fun insert(team: TeamData) {
        teamDao.insert(teamDataToLocalMapper.map(team))
    }
    ...
    override suspend fun star(id: Int, isStarred: Boolean) {
        teamDao.star(id, isStarred)
    }
}